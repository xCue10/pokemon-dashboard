...
export function catchToast(message) {
  toast.custom(
    (t) => (
      <div className="catch-toast" style={{ opacity: t.visible ? 1 : 0, transition: 'opacity 0.15s' }}>
        <svg viewBox="0 0 100 100" width="30" height="30" className="pb-catch flex-shrink-0">
          ...
          <circle cx="50" cy="50" r="7" stroke="#333" strokeWidth="2" className="pb-catch-flash" />
